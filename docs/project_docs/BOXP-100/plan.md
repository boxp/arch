...
11. review feedback に対応し、Novel Board 冒頭と `Novels/README.md` に手動追加・各レーン・レビュー・公開ルールを明記する。`Backlog` のタイトルだけカードを `NOVEL-N` 正規カードへ冪等 scaffold し、`Templates/Novel Management.md` から管理ノートを生成する。
