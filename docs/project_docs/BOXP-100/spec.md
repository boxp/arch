...
- SIGTERM/preStop は owner marker を作り、同じ owner の lock を次の instance が即時回収できる。異常終了時は stale fallback を使う。
...
- `CODEX_NOVEL_BOARD_BYPASS_APPROVALS`、`CODEX_NOVEL_BOARD_SANDBOX`
