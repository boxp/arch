...
resource "cloudflare_access_application" "hermes_agent" {
  zone_id          = var.zone_id
...
resource "cloudflare_access_policy" "hermes_agent_policy" {
  application_id = cloudflare_access_application.hermes_agent.id
  zone_id        = var.zone_id
