resource "cloudflare_access_application" "stable_diffusion" {
  zone_id          = var.zone_id
...
resource "cloudflare_access_policy" "stable_diffusion_github" {
  application_id = cloudflare_access_application.stable_diffusion.id
  zone_id        = var.zone_id
