...
resource "aws_ssm_parameter" "cf_access_client_id" {
  ...
  type        = "SecureString"
  value       = sensitive(cloudflare_zero_trust_access_service_token.github_actions.client_id)
}
...
resource "aws_ssm_parameter" "cf_access_client_secret" {
  ...
  type        = "SecureString"
  value       = sensitive(cloudflare_zero_trust_access_service_token.github_actions.client_secret)
}
